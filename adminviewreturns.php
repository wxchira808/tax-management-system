...
if (isset($_POST['submit']))
{
	...
	$sql="SELECT * FROM tax_return WHERE date BETWEEN '$from_date'AND'$to_date' AND  taxpayer_id LIKE '$taxpayerid' ORDER BY tax_year DESC ";

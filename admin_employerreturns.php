...
{
	$search=($_POST)['search'];
	$sql="SELECT * FROM tax_return JOIN user ON tax_return.taxpayer_id=user.taxpayer_id WHERE tax_month LIKE '%$search%' AND email = '$name'";
	$result=mysqli_query($data,$sql);
} */
...
if (isset($_POST['submit']))
{
	...
	$sql="SELECT * FROM employer_return WHERE date BETWEEN '$from_date'AND'$to_date' AND employer_id LIKE '$employerid' ORDER BY date DESC ";
...
<html>
<head>
	<title>View Employer Returns</title>
...
<div class="content">
		...
		<div >
			<h1 >Search Tax Returns</h1><br><br>
		...
		<form method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">
			...
			<div>
				...
				<input style="width:200px; height: 30px;" type="text" name="employer_id" required placeholder="Employer ID"><br><br>
